...
import RotaProtegida from "./components/RotaProtegida"; // Presumo que este seja o seu PrivateRoute
      ...
      <Routes>
        ...
        <Route element={<RotaProtegida />}>
          ...
          <Route element={<Home />}>
            ...
            {/* páginas dentro do Home (Layout) */}
            
            {/* Agora os caminhos são relativos à raiz '/', e não a '/Home'
              Ex: /Board, /PainelEstudante, etc.
            */}
          ...
          </Route>  {/* fim do Layout <Home /> */}
        </Route>  {/* fim da Rota protegida */}
      </Routes>
